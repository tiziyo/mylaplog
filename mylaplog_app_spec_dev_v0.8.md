...
- **정차 시간 & 릴리즈 카운트다운**: 피트 박스 정차(속도 < 2.5 km/h) 감지, 의무 피트(5분 기본 / 60s / 75s) / 정차(30s / 45s) 규정시간 대비 3-2-1 비프 카운트다운 및 녹색 GO 릴리즈 차임
- **규정 시간 임박 알람 설정**: 5초/10초(기본)/15초/20초/30초 전 또는 OFF 설정 지원, 설정된 잔여 시간 도달 시 듀얼 톤 사전 예비 차임 및 시각적 주황 하이라이트 발생
